(function () {
  ...
  style.textContent = `
    ...
    #samify-launcher {
      ...
      background: #fff; border: 1.5px solid #e8e8ec; cursor: pointer;
    ...
    #samify-launcher::after {
      ...
      top: -60%; left: -80%;
      width: 50%; height: 220%;
      background: linear-gradient(105deg, transparent 30%, rgba(124,58,237,0.08) 50%, transparent 70%);
    ...
    #samify-launcher:hover { transform: scale(1.07); box-shadow: 0 6px 24px rgba(124,58,237,0.2); border-color: #7c3aed; }
  ...
  wrap.innerHTML = `
    <button id="samify-launcher" onclick="swToggle()" aria-label="Öppna support">
      <svg class="si-chat" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#7c3aed" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
      <svg class="si-close" style="display:none" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#7c3aed" stroke-width="2.5" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
    </button>
  ...
  // GET via image pixel — ingen CORS, ingen preflight
  var img = new Image();
  img.src = ZAPIER_WEBHOOK_URL + '?' + params.toString();
}
